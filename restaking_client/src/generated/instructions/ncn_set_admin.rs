...
pub struct NcnSetAdminInstructionData {
    discriminator: u8,
}

impl NcnSetAdminInstructionData {
    pub fn new() -> Self {
        Self { discriminator: 17 }
    }
}

impl Default for NcnSetAdminInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `NcnSetAdmin`.
///
/// ### Accounts:
///
///   0. `[writable]` ncn
...
/// `ncn_set_admin` CPI accounts.
pub struct NcnSetAdminCpiAccounts<'a, 'b> {
...
/// `ncn_set_admin` CPI instruction.
pub struct NcnSetAdminCpi<'a, 'b> {
...
impl<'a, 'b> NcnSetAdminCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: NcnSetAdminCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
            ncn: accounts.ncn,
...
/// Instruction builder for `NcnSetAdmin` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` ncn
...
///   2. `[signer]` new_admin
#[derive(Clone, Debug)]
pub struct NcnSetAdminCpiBuilder<'a, 'b> {
    instruction: Box<NcnSetAdminCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> NcnSetAdminCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(NcnSetAdminCpiBuilderInstruction {
            __program: program,
            ncn: None,
            old_admin: None,
            new_admin: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = NcnSetAdminCpi {
...
#[derive(Clone, Debug)]
struct NcnSetAdminCpiBuilderInstruction<'a, 'b> {

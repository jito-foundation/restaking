...
export const HARVEST_LAMPORTS_DISCRIMINATOR = 23;
...
export type HarvestLamportsInstruction<
  ...
  TAccountConfigNcnOrOperator extends string | IAccountMeta<string> = string,
...
> = IInstruction<TProgram> &
  ...
  IInstructionWithAccounts<
    [
      ...
      TAccountConfigNcnOrOperator extends string
        ? ReadonlyAccount<TAccountConfigNcnOrOperator>
        : TAccountConfigNcnOrOperator,
...
export type HarvestLamportsInput<
  ...
  TAccountConfigNcnOrOperator extends string = string,
  TAccountHarvestAdmin extends string = string,
  TAccountDestination extends string = string,
> = {
  programAccount: Address<TAccountProgramAccount>;
  configNcnOrOperator: Address<TAccountConfigNcnOrOperator>;
...
> {
  ...
  const originalAccounts = {
    ...
    configNcnOrOperator: {
      value: input.configNcnOrOperator ?? null,
      isWritable: false,
    },
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.configNcnOrOperator),
...
> = {
  ...
  accounts: {
    ...
    configNcnOrOperator: TAccountMetas[1];
...
>(
  ...
  return {
    ...
    accounts: {
      ...
      configNcnOrOperator: getNextAccount(),

...
export const JITO_VAULT_ERROR__VAULT_REWARD_FEE_DELTA_TOO_LARGE = 0x418; // 1048
/** VaultRewardFeeIsZero: VaultFeeIsZero */
export const JITO_VAULT_ERROR__VAULT_REWARD_FEE_IS_ZERO = 0x419; // 1049
...
if (process.env.NODE_ENV !== 'production') {
  jitoVaultErrorMessages = {
    ...
    [JITO_VAULT_ERROR__VAULT_REWARD_FEE_IS_ZERO]: `VaultFeeIsZero`,

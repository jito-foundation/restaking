...
/** VaultDoesNotHaveEnoughTokensToDetermineRewards: VaultDoesNotHaveEnoughTokensToDetermineRewards */
export const JITO_VAULT_ERROR__VAULT_DOES_NOT_HAVE_ENOUGH_TOKENS_TO_DETERMINE_REWARDS = 0x422; // 1058
...
export type JitoVaultError =
  ...
  | typeof JITO_VAULT_ERROR__VAULT_DOES_NOT_HAVE_ENOUGH_TOKENS_TO_DETERMINE_REWARDS
...
if (process.env.NODE_ENV !== 'production') {
  jitoVaultErrorMessages = {
    ...
    [JITO_VAULT_ERROR__VAULT_DOES_NOT_HAVE_ENOUGH_TOKENS_TO_DETERMINE_REWARDS]: `VaultDoesNotHaveEnoughTokensToDetermineRewards`,

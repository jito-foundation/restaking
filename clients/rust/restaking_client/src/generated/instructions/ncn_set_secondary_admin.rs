...
impl NcnSetSecondaryAdmin {
  pub fn instruction(&self, args: NcnSetSecondaryAdminInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: NcnSetSecondaryAdminInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = NcnSetSecondaryAdminInstructionData::new().try_to_vec().unwrap();
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = NcnSetSecondaryAdmin {
          ...
          let args = NcnSetSecondaryAdminInstructionArgs {
                                                              ncn_admin_role: self.ncn_admin_role.clone().expect("ncn_admin_role is not set"),
                                    };
...
impl<'a, 'b> NcnSetSecondaryAdminCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = NcnSetSecondaryAdminInstructionArgs {
                                                              ncn_admin_role: self.instruction.ncn_admin_role.clone().expect("ncn_admin_role is not set"),
                                    };

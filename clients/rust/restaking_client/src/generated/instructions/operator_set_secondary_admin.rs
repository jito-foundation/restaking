...
impl OperatorSetSecondaryAdmin {
  pub fn instruction(&self, args: OperatorSetSecondaryAdminInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: OperatorSetSecondaryAdminInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = OperatorSetSecondaryAdminInstructionData::new().try_to_vec().unwrap();
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OperatorSetSecondaryAdmin {
          ...
          let args = OperatorSetSecondaryAdminInstructionArgs {
                                                              operator_admin_role: self.operator_admin_role.clone().expect("operator_admin_role is not set"),
                                    };
...
impl<'a, 'b> OperatorSetSecondaryAdminCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = OperatorSetSecondaryAdminInstructionArgs {
                                                              operator_admin_role: self.instruction.operator_admin_role.clone().expect("operator_admin_role is not set"),
                                    };

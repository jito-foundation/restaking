...
impl InitializeNcnVaultSlasherTicket {
  pub fn instruction(&self, args: InitializeNcnVaultSlasherTicketInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeNcnVaultSlasherTicketInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = InitializeNcnVaultSlasherTicketInstructionData::new().try_to_vec().unwrap();

...
impl OperatorDelegateTokenAccount {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = OperatorDelegateTokenAccountInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> OperatorDelegateTokenAccountCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn operator(&mut self, operator: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn delegate_admin(&mut self, delegate_admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          delegate_admin: self.instruction.delegate_admin.expect("delegate_admin is not set"),

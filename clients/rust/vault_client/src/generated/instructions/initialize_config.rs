...
impl InitializeConfigBuilder {
  pub fn new() -> Self {
    ...
    pub fn admin(&mut self, admin: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn restaking_program(&mut self, restaking_program: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.restaking_program = Some(restaking_program);
                    self
    }
            #[inline(always)]
    pub fn program_fee_wallet(&mut self, program_fee_wallet: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InitializeConfig {
                              config: self.config.expect("config is not set"),
                                        ...
                                        restaking_program: self.restaking_program.expect("restaking_program is not set"),
                                        program_fee_wallet: self.program_fee_wallet.expect("program_fee_wallet is not set"),
                                        system_program: self.system_program.unwrap_or(solana_program::pubkey!("11111111111111111111111111111111")),
                      };
          let args = InitializeConfigInstructionArgs {
                                                              program_fee_bps: self.program_fee_bps.clone().expect("program_fee_bps is not set"),
                                    };
...
impl<'a, 'b> InitializeConfigCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn admin(&mut self, admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn restaking_program(&mut self, restaking_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.restaking_program = Some(restaking_program);
                    self
    }
      #[inline(always)]
    pub fn program_fee_wallet(&mut self, program_fee_wallet: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitializeConfigInstructionArgs {
                                                              program_fee_bps: self.instruction.program_fee_bps.clone().expect("program_fee_bps is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          restaking_program: self.instruction.restaking_program.expect("restaking_program is not set"),
                  
          program_fee_wallet: self.instruction.program_fee_wallet.expect("program_fee_wallet is not set"),

...
impl BurnWithdrawalTicket {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = BurnWithdrawalTicketInstructionData::new().try_to_vec().unwrap();
...
impl BurnWithdrawalTicketBuilder {
  pub fn new() -> Self {
    ...
    pub fn vault(&mut self, vault: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn vault_token_account(&mut self, vault_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn staker(&mut self, staker: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn staker_token_account(&mut self, staker_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.staker_token_account = Some(staker_token_account);
                    self
    }
            #[inline(always)]
    pub fn vault_staker_withdrawal_ticket(&mut self, vault_staker_withdrawal_ticket: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.vault_staker_withdrawal_ticket = Some(vault_staker_withdrawal_ticket);
                    self
    }
            #[inline(always)]
    pub fn vault_staker_withdrawal_ticket_token_account(&mut self, vault_staker_withdrawal_ticket_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.vault_staker_withdrawal_ticket_token_account = Some(vault_staker_withdrawal_ticket_token_account);
                    self
    }
            #[inline(always)]
    pub fn vault_fee_token_account(&mut self, vault_fee_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.vault_fee_token_account = Some(vault_fee_token_account);
                    self
    }
            #[inline(always)]
    pub fn program_fee_token_account(&mut self, program_fee_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
/// Signer for burning
#[inline(always)]
    pub fn burn_signer(&mut self, burn_signer: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = BurnWithdrawalTicket {
                              config: self.config.expect("config is not set"),
                                        ...
                                        staker_token_account: self.staker_token_account.expect("staker_token_account is not set"),
                                        vault_staker_withdrawal_ticket: self.vault_staker_withdrawal_ticket.expect("vault_staker_withdrawal_ticket is not set"),
                                        vault_staker_withdrawal_ticket_token_account: self.vault_staker_withdrawal_ticket_token_account.expect("vault_staker_withdrawal_ticket_token_account is not set"),
                                        vault_fee_token_account: self.vault_fee_token_account.expect("vault_fee_token_account is not set"),
                                        program_fee_token_account: self.program_fee_token_account.expect("program_fee_token_account is not set"),
  ...
  pub struct BurnWithdrawalTicketCpiAccounts<'a, 'b> {
              ...
              pub vault_staker_withdrawal_ticket_token_account: &'b solana_program::account_info::AccountInfo<'a>,
  ...
  pub fn new(
    ...
    Self {
      __program: program,
              ...
              vault_staker_withdrawal_ticket_token_account: accounts.vault_staker_withdrawal_ticket_token_account,
...
impl<'a, 'b> BurnWithdrawalTicketCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn vault(&mut self, vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn vault_token_account(&mut self, vault_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn staker(&mut self, staker: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn staker_token_account(&mut self, staker_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.staker_token_account = Some(staker_token_account);
                    self
    }
      #[inline(always)]
    pub fn vault_staker_withdrawal_ticket(&mut self, vault_staker_withdrawal_ticket: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.vault_staker_withdrawal_ticket = Some(vault_staker_withdrawal_ticket);
                    self
    }
      #[inline(always)]
    pub fn vault_staker_withdrawal_ticket_token_account(&mut self, vault_staker_withdrawal_ticket_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.vault_staker_withdrawal_ticket_token_account = Some(vault_staker_withdrawal_ticket_token_account);
                    self
    }
      #[inline(always)]
    pub fn vault_fee_token_account(&mut self, vault_fee_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.vault_fee_token_account = Some(vault_fee_token_account);
                    self
    }
      #[inline(always)]
    pub fn program_fee_token_account(&mut self, program_fee_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
/// Signer for burning
#[inline(always)]
    pub fn burn_signer(&mut self, burn_signer: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          staker_token_account: self.instruction.staker_token_account.expect("staker_token_account is not set"),
                  
          vault_staker_withdrawal_ticket: self.instruction.vault_staker_withdrawal_ticket.expect("vault_staker_withdrawal_ticket is not set"),
                  
          vault_staker_withdrawal_ticket_token_account: self.instruction.vault_staker_withdrawal_ticket_token_account.expect("vault_staker_withdrawal_ticket_token_account is not set"),
                  
          vault_fee_token_account: self.instruction.vault_fee_token_account.expect("vault_fee_token_account is not set"),
                  
          program_fee_token_account: self.instruction.program_fee_token_account.expect("program_fee_token_account is not set"),
...
struct BurnWithdrawalTicketCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            config: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                vault_staker_withdrawal_ticket_token_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,

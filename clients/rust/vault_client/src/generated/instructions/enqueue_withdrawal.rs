...
impl EnqueueWithdrawal {
  pub fn instruction(&self, args: EnqueueWithdrawalInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: EnqueueWithdrawalInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = EnqueueWithdrawalInstructionData::new().try_to_vec().unwrap();
...
impl EnqueueWithdrawalBuilder {
  pub fn new() -> Self {
    ...
    pub fn staker(&mut self, staker: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn staker_vrt_token_account(&mut self, staker_vrt_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = EnqueueWithdrawal {
                              config: self.config.expect("config is not set"),
                                        ...
                                        staker_vrt_token_account: self.staker_vrt_token_account.expect("staker_vrt_token_account is not set"),
...
impl<'a, 'b> EnqueueWithdrawalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn staker(&mut self, staker: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn staker_vrt_token_account(&mut self, staker_vrt_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          staker_vrt_token_account: self.instruction.staker_vrt_token_account.expect("staker_vrt_token_account is not set"),

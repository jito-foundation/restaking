...
impl SetIsPaused {
  pub fn instruction(&self, args: SetIsPausedInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetIsPausedInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl<'a, 'b> SetIsPausedCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SetIsPausedInstructionArgs {
                                                              is_paused: self.instruction.is_paused.clone().expect("is_paused is not set"),
                                    };

...
impl ChangeWithdrawalTicketOwner {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = ChangeWithdrawalTicketOwnerInstructionData::new().try_to_vec().unwrap();
...
impl<'a, 'b> ChangeWithdrawalTicketOwnerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn vault_staker_withdrawal_ticket(&mut self, vault_staker_withdrawal_ticket: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn old_owner(&mut self, old_owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.old_owner = Some(old_owner);
                    self
    }
      #[inline(always)]
    pub fn new_owner(&mut self, new_owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {

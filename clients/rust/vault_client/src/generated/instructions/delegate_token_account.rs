...
impl DelegateTokenAccount {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = DelegateTokenAccountInstructionData::new().try_to_vec().unwrap();
...
impl DelegateTokenAccountBuilder {
  pub fn new() -> Self {
    ...
    pub fn vault(&mut self, vault: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn delegate_asset_admin(&mut self, delegate_asset_admin: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DelegateTokenAccount {
                              config: self.config.expect("config is not set"),
                                        ...
                                        delegate_asset_admin: self.delegate_asset_admin.expect("delegate_asset_admin is not set"),
...
impl<'a, 'b> DelegateTokenAccountCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn vault(&mut self, vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn delegate_asset_admin(&mut self, delegate_asset_admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          delegate_asset_admin: self.instruction.delegate_asset_admin.expect("delegate_asset_admin is not set"),

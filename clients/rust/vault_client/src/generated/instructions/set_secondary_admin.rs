...
impl SetSecondaryAdmin {
  pub fn instruction(&self, args: SetSecondaryAdminInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetSecondaryAdminInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = SetSecondaryAdminInstructionData::new().try_to_vec().unwrap();
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetSecondaryAdmin {
          ...
          let args = SetSecondaryAdminInstructionArgs {
                                                              vault_admin_role: self.vault_admin_role.clone().expect("vault_admin_role is not set"),
                                    };
...
impl<'a, 'b> SetSecondaryAdminCpiBuilder<'a, 'b> {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = SetSecondaryAdminInstructionArgs {
                                                              vault_admin_role: self.instruction.vault_admin_role.clone().expect("vault_admin_role is not set"),
                                    };

...
impl SetProgramFeeWallet {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = SetProgramFeeWalletInstructionData::new().try_to_vec().unwrap();
...
impl SetProgramFeeWalletBuilder {
  pub fn new() -> Self {
    ...
    pub fn config(&mut self, config: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn program_fee_admin(&mut self, program_fee_admin: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetProgramFeeWallet {
                              config: self.config.expect("config is not set"),
                                        program_fee_admin: self.program_fee_admin.expect("program_fee_admin is not set"),
...
impl<'a, 'b> SetProgramFeeWalletCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn config(&mut self, config: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn program_fee_admin(&mut self, program_fee_admin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.program_fee_admin = Some(program_fee_admin);
                    self
    }
      #[inline(always)]
    pub fn new_fee_wallet(&mut self, new_fee_wallet: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          program_fee_admin: self.instruction.program_fee_admin.expect("program_fee_admin is not set"),
                  
          new_fee_wallet: self.instruction.new_fee_wallet.expect("new_fee_wallet is not set"),
                    };

...
impl InitializeVaultNcnSlasherTicket {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = InitializeVaultNcnSlasherTicketInstructionData::new().try_to_vec().unwrap();
...
impl InitializeVaultNcnSlasherTicketBuilder {
  pub fn new() -> Self {
    ...
    pub fn slasher(&mut self, slasher: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn ncn_slasher_ticket(&mut self, ncn_slasher_ticket: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InitializeVaultNcnSlasherTicket {
                              config: self.config.expect("config is not set"),
                                        ...
                                        ncn_slasher_ticket: self.ncn_slasher_ticket.expect("ncn_slasher_ticket is not set"),
...
impl<'a, 'b> InitializeVaultNcnSlasherTicketCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn slasher(&mut self, slasher: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn ncn_slasher_ticket(&mut self, ncn_slasher_ticket: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          ncn_slasher_ticket: self.instruction.ncn_slasher_ticket.expect("ncn_slasher_ticket is not set"),

...
mod tests {
    ...
    #[tokio::test]
    async fn test_operator_cooldown_ncn_ok() {
        ...
        assert_eq!(
            ncn_operator_state.operator_opt_in_state.state(
    ...
    #[tokio::test]
    async fn test_operator_cooldown_ncn_wrong_admin_fails() {
        let mut fixture = TestBuilder::new().await;
        let mut restaking_program_client = fixture.restaking_program_client();
    ...
    #[tokio::test]
    async fn test_operator_cooldown_ncn_inactive_fails() {
        ...
        let result = restaking_program_client
            .do_operator_cooldown_ncn(&operator_root, &ncn_root.ncn_pubkey)
            .await;
        assert_restaking_error(result, RestakingError::OperatorCooldownNcnFailed);
    }

    #[tokio::test]
    async fn test_operator_cooldown_ncn_warming_up_fails() {
        let fixture = TestBuilder::new().await;
        let mut restaking_program_client = fixture.restaking_program_client();
    ...
    #[tokio::test]
    async fn test_operator_cooldown_ncn_cooling_down_fails() {
        let mut fixture = TestBuilder::new().await;
        let mut restaking_program_client = fixture.restaking_program_client();

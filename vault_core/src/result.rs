...
pub enum VaultCoreError {
    ...
    VaultStakerWithdrawTicketEmptyInvalidOwner,
    VaultStakerWithdrawTicketEmptyInvalidData(String),
    VaultStakerWithdrawTicketEmptyInvalidAccountType,
    VaultStakerWithdrawTicketEmptyInvalidPda,
    VaultStakerWithdrawTicketInvalidProgramOwner,
    VaultStakerWithdrawTicketNotWritable,
